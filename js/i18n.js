...
const I18n = (() => {
  ...
  const STRINGS = {
    es: {
      ...
      orientToLandscape: 'Jugar en horizontal',
      orientToPortrait: 'Jugar en vertical',
      share: '📤 COMPARTIR',
    ...
    errCuentaNoExiste: 'No existe una cuenta con ese nombre. ¿Querías crearla?',
      ...
      shopAdsSoon: 'Los anuncios solo están en la app de Android',
      shopAdsWatch: '🎬 VER ANUNCIO',
      shopAdsNeedAccount: 'Vincula una cuenta para ver anuncios',
      adWatched: '🎬 Anuncio visto ({n}/{t})',
      adWatchedCoins: '🎬 Anuncio visto ({n}/{t}) · +{c} 🪙',
      adCoinsOk: '¡+{n} monedas!',
      adLimit: 'Ya viste todos los anuncios de hoy',
      adFail: 'No se pudo cargar el anuncio',
      adSkipped: 'Mira el anuncio completo para revivir',
      reviveTitle: '¿SEGUIR JUGANDO?',
      reviveDesc: 'Mira un anuncio y vuelve a la vía donde caíste.',
      reviveNote: 'Llevas {m} m. Todo lo que recorras después se suma a tu marca y al ranking.',
      reviveBtn: '🎬 REVIVIR',
      reviveNo: 'NO, GRACIAS',
      reviveLoading: 'Cargando anuncio…',
      goRevivedTotal: '¡Revivir te sumó {n} m!',
      rarityComun: 'Común',
      rarityRara: 'Rara',
      rarityEpica: 'Épica',
      rarityLegendaria: 'Legendaria',
      shopSoon: 'Próximamente',
      skinPerkCoins: '+{n}% monedas',
      ...
      errSinConexion: 'No se pudo conectar. Revisa tu internet e inténtalo de nuevo',
      linkOk: '✓ Cuenta vinculada',
      adCoinsHint: 'Gana {n} monedas viendo un anuncio',
      redeemBtn: 'CANJEAR',
    ...
    en: {
      ...
      orientToLandscape: 'Play in landscape',
      orientToPortrait: 'Play in portrait',
      share: '📤 SHARE',
    ...
    errCuentaNoExiste: 'No account with that name. Did you mean to create it?',
      ...
      shopAdsSoon: 'Ads are only available in the Android app',
      shopAdsWatch: '🎬 WATCH AD',
      shopAdsNeedAccount: 'Link an account to watch ads',
      adWatched: '🎬 Ad watched ({n}/{t})',
      adWatchedCoins: '🎬 Ad watched ({n}/{t}) · +{c} 🪙',
      adCoinsOk: '+{n} coins!',
      adLimit: "You have watched all of today's ads",
      adFail: 'The ad could not be loaded',
      adSkipped: 'Watch the whole ad to revive',
      reviveTitle: 'KEEP GOING?',
      reviveDesc: 'Watch an ad and get back on the track where you fell.',
      reviveNote: 'You are at {m} m. Everything you cover afterwards counts toward your score and the ranking.',
      reviveBtn: '🎬 REVIVE',
      reviveNo: 'NO THANKS',
      reviveLoading: 'Loading ad…',
      goRevivedTotal: 'Reviving added {n} m!',
      rarityComun: 'Common',
      rarityRara: 'Rare',
      rarityEpica: 'Epic',
      rarityLegendaria: 'Legendary',
      shopSoon: 'Coming soon',
      skinPerkCoins: '+{n}% coins',
      ...
      errSinConexion: 'Could not connect. Check your internet and try again',
      linkOk: '✓ Account linked',
      adCoinsHint: 'Earn {n} coins by watching an ad',
      redeemBtn: 'REDEEM',
