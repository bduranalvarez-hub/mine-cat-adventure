...
const I18n = (() => {
  ...
  const STRINGS = {
    ...
    errCuentaNoExiste: 'No existe una cuenta con ese nombre. ¿Querías crearla?',
      ...
      reviveNote: 'Tu marca quedó en {m} m. Revivir suma monedas, no puntos.',
      reviveBtn: '🎬 REVIVIR',
      reviveNo: 'NO, GRACIAS',
      reviveLoading: 'Cargando anuncio…',
      goRevivedTotal: 'Recorriste {m} m en total, pero tu marca fue {s} m.',
      rarityComun: 'Común',
      rarityRara: 'Rara',
      rarityEpica: 'Épica',
    ...
    errCuentaNoExiste: 'No account with that name. Did you mean to create it?',
      ...
      reviveNote: 'Your score is locked at {m} m. Reviving earns coins, not points.',
      reviveBtn: '🎬 REVIVE',
      reviveNo: 'NO THANKS',
      reviveLoading: 'Loading ad…',
      goRevivedTotal: 'You covered {m} m in total, but your score was {s} m.',
      rarityComun: 'Common',
      rarityRara: 'Rare',
      rarityEpica: 'Epic',
