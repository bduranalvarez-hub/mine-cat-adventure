...
-- jugadores reales.
--   ZzCaseRank / CaseT / RankCase / RLTest / RLOk / DirectCallTest /
--   DebugTest / UserA / UserB / UserC
...
--    or name ~* '^(ZzCaseRank|CaseT|RankCase|RLTest|RLOk|DirectCallTest|DebugTest|UserA|UserB|UserC)'
...
where name ~* '^(ZzCaseRank|CaseT|RankCase|RLTest|RLOk|DirectCallTest|DebugTest|UserA|UserB|UserC)';
